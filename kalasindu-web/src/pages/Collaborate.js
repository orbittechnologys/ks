...
function Collaborate() {
  ...
  return (
    <>
      <Navbar />
      <section className="hero-wrapper position-relative" style={{marginTop:'80px'}}>
        ...
        <div className="hero-overlay d-flex align-items-center justify-content-around">
          <div className="d-flex flex-column justify-content-end">
            <div>
              ...
              <p style={{width:'1110px', fontSize:'25px'}}
      ...
      <h1 className="text-white fw-bolder" style={{fontSize:'64px', fontWeight:'600',  paddingLeft:"50px"}}data-aos="fade-right"
      data-aos-duration="3000">
        ...
        <div className="d-flex justify-content-around align-self-center mt-5">
              ...
              <div className="col-lg-6">
                <p className="text-white" style={{fontSize:'30px', width:'672px'}}data-aos="fade-up" data-aos-duration="2800">
        ...
        <div className="d-flex justify-content-around align-self-center"style={{ backgroundColor: "#003D1B", height:'652px' }}>
              <div className="d-flex justify-content-between align-items-center">
                <img src={colImg2} height={362} alt="Hero Image"  />
              </div>
              <div style={{marginTop:'140px'}}>
              <h1 className="text-white fw-bolder" style={{fontSize:'64px', fontWeight:'600'}}data-aos="fade-right"
              data-aos-duration="3000">
                  Kalasindhu is Looking for ....
              </h1>
                <p className="text-white mt-5" style={{fontSize:'30px', width:'672px'}}data-aos="fade-up" data-aos-duration="2800">
                  Dancers, muscicians, photographers and anyone else who is
                  bursting with ideas and who would like to share and contribute
                  to the creative space.
                </p>
        ...
        <div style={{ backgroundColor: "#330A0A", height:'652px' }}>
          <div className="container">
            <div className="row p-5 ">
              <div className="col-lg-6">
                <h1 className="text-white display-5 fw-bolder mt-5" style={{fontSize:'64px', fontWeight:'600'}}data-aos="fade-left"
                data-aos-duration="3000">
                  Showcase your art
                </h1>
                <p className="text-white" style={{fontSize:'30px', marginTop:'50px'}}data-aos="fade-up"
                data-aos-duration="3000">
                  Dancers, muscicians, photographers and anyone else who is
                  bursting with ideas and who would like to share and contribute
                  to the creative space.{" "}
