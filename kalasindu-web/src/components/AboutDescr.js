...
function AboutDescr() {
  ...
  return (
    <><div className="mt-5" style={{overflow: "hidden"}}>
            ...
            <div className="imgcenterd">
            <h1
            className="text-center font-weight-bold "
            style={{ marginTop: "200px", fontSize: "48px",fontFamily:'Oswald' }}
            data-aos="fade-down"
          ...
          <p
            style={{ padding: "55px", lineHeight: "2" ,fontFamily:'Open Sans'}}
      ...
      >
        ...
        <h1
          ...
          <p
            style={{ fontWeight: 200, alignItems:'center', fontSize:'16px',fontFamily:'Open Sans' }}
            data-aos="fade-left"
